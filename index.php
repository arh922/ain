...
include("includes/header.php");//git
?>
<div id="new-task" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div id="navigation">
        <div class="container-fluid">
            <a href="<?php echo $base_path; ?>" id="brand">AMC</a>
            ...
            <div class="user">
                <ul class="icon-nav">
                    ...
                    <li class='dropdown language-select'>
                        <a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="<?php echo $base_path; ?>img/demo/flags/us.gif" alt=""><span>US</span></a>
                        <ul class="dropdown-menu pull-right">
                            <li>
                                <a href="#"><img src="<?php echo $base_path; ?>img/demo/flags/br.gif" alt=""><span>Brasil</span></a>
                            </li>
                            <li>
                                <a href="#"><img src="<?php echo $base_path; ?>img/demo/flags/de.gif" alt=""><span>Deutschland</span></a>
                            </li>
                            <li>
                                <a href="#"><img src="<?php echo $base_path; ?>img/demo/flags/es.gif" alt=""><span>España</span></a>
                            </li>
                            <li>
                                <a href="#"><img src="<?php echo $base_path; ?>img/demo/flags/fr.gif" alt=""><span>France</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                ?>
                    <div class="dropdown">
                        <a href="#" class='dropdown-toggle' data-toggle="dropdown"><?php echo $user['username']; ?> <img src="<?php echo $base_path; ?>img/demo/user-avatar.jpg" alt=""></a>
                        <ul class="dropdown-menu pull-right">
                            <li>
                            ...
                            <li>
                                <a href="<?php echo $base_path?>logout">Sign out</a>
                            </li>
                        </ul>
                    </div>
                <?php
