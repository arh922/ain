...
* @Description: class used for the parsing  
* @Param:
*   none
* @Updated History:
*    none
...
class cURL{
    ...
    function cURL($cookies = TRUE, $cookie = '/tmp/cookies.txt', $compression = 'gzip,deflate', $proxy = ''){   
    ...
    function get($url){
        ...
        curl_setopt($process, CURLOPT_REFERER, '[url=http://www.google.com]http://www.google.com[/url]');
